    ...
    return (
        <Menu className='sticky-top' theme="light" mode="inline" defaultSelectedKeys={['1']}>
            <Menu.Item
                ...
                onClick={() => handleMenu('Timeline of Genorisity', <Dashboard/>)}> Dashboard </Menu.Item>
            ...
            <Menu.Item
                ...
                onClick={() => handleMenu('Requests', <Users/>)}> Users </Menu.Item>
            ...
            <Menu.Item
                ...
                onClick={() => handleMenu('Photo Gallery', <NovelList />)}>  Novels </Menu.Item>
            ...
            <Menu.Item
                ...
                onClick={() => handleMenu('Manage Volunteers', <Artworks/>)}> Artworks </Menu.Item>
            ...
            <Menu.Item
                ...
                onClick={() => handleMenu('Manage Donors', <Forums/>)}> Forums </Menu.Item>
            ...
            <Menu.Item
                ...
                onClick={() => handleMenu('Manage Admins', <NovelList />)}> Stored Content </Menu.Item>
            ...
            <Menu.Item
                ...
                onClick={() => handleMenu('Manage Admins', <NovelList />)}> Donation </Menu.Item>
...
<Menu.Item
                ...
                onClick={() => handleMenu('Logout', <NovelList />)}> Logout </Menu.Item>
        </Menu>
    );
};
